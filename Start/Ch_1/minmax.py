...
print("data['metadata']['title']", data['metadata']['title'])
print("len(data['features'])", len(data['features']))
...
print("min(data['features'], key=get_mag)", min(data['features'], key=get_mag))
print("max(data['features'], key=get_mag)", max(data['features'], key=get_mag))
